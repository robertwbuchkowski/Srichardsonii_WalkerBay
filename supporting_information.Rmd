...
knitr::kable("latex", escape=F, caption = "Sampling regime for the shrubs using in our dendrochronological analysis. N is the number of shrub branches sampled, each from an individual shrub.") %>%
